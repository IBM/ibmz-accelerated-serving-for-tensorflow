...
IMAGE_TAG="tensorflow-serving-ccf-sample:${TIMESTAMP}"
VOLUME_NAME="tensorflow-serving-ccf-workspace"
...
echo "      ${IMAGE_TAG}"
echo ""
echo "See the sample README for instructions on copying training artifacts"
